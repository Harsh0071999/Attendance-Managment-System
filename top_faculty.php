...
<html lang="en"><head>
  ...
  <body>
    <div class="container-scroller" style="padding-top: 20px;">
      <!-- partial:partials/_navbar.html -->
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
                <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">

          <a class="navbar-brand brand-logo" href="faculty_home.php?id=<?php echo $encrypt?>"><h3 style="color: white;">
               <span style="color: red;">G</span>anpat University</h3>
          <a class="navbar-brand brand-logo-mini" href="faculty_home.php?id=<?php echo $encrypt?>">
    ...
    {?>
      ...
      <a class="dropdown-item py-1 d-flex align-items-center justify-content-between" href="faculty_home.php"></a>
    ...
    <?php
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            <li class="nav-item">
              <a class="nav-link" href="faculty_home.php?id=<?php echo $encrypt?>">
                <span class="icon-bg"><i class="mdi mdi-format-list-bulleted menu-icon"></i></span>
                <span class="menu-title">Home</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="faculty_alotclass.php?id=<?php echo $encrypt?>">
                <span class="icon-bg"><i class="mdi mdi-cube menu-icon"></i></span>
                <span class="menu-title">Alot Classes</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="faculty_student.php?id=<?php echo $encrypt?>">
                <span class="icon-bg"><i class="mdi mdi-crosshairs-gps menu-icon"></i></span>
                <span class="menu-title">Student</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="faculty_quiz.php?id=<?php echo $encrypt?>">
                <span class="icon-bg"><i class="mdi mdi-contacts menu-icon"></i></span>
                <span class="menu-title">Quiz</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="faculty_attendancerecord.php?id=<?php echo $encrypt?>">
                <span class="icon-bg"><i class="mdi mdi-format-list-bulleted menu-icon"></i></span>
                <span class="menu-title">Attendance Record</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="faculty_edit_profile.php?id=<?php echo $encrypt?>">
                <span class="icon-bg"><i class="mdi mdi-format-list-bulleted menu-icon"></i></span>
